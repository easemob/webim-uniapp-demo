...
@protocol EMPlayingSourceDelegate;
@protocol EMWebRTCAudioDataDelegate;
RTC_OBJC_EXPORT
...
- (instancetype)initWithEncoderFactory:(nullable id<RTCVideoEncoderFactory>)encoderFactory
                     ...
                     audioDataDelegate:(nullable id<EMWebRTCAudioDataDelegate>)aDelegate
                 playingSourceDelegate:(nullable id<EMPlayingSourceDelegate>)aDelegate;
