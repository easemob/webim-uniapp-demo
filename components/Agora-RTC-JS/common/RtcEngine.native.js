...
export default class RtcEngine {
  ...
  enableLocalVoicePitchCallback(interval) {
    return RtcEngine._callMethod('enableLocalVoicePitchCallback', {
      interval
    });
  }
  /**
  ...
  enableSpatialAudio(enabled) {
    return RtcEngine._callMethod('enableSpatialAudio', {
      enabled
    });
  }
  /**
  ...
  updateScreenCaptureParameters(parameters) {
